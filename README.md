...
(forked from https://github.com/DandyDev, https://github.com/timbaileyjones/virtual-hadoop-cluster, but modified to manager install)/
...
```bash
$ git clone https://github.com/kzfk/virtual-hadoop-cluster.git
```
